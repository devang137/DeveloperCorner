...
?>
            ...
            <div class="primary col-lg-8 col-12">
                <section class="about section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <p>An energetic and imaginative young web developer who is able to work alongside other talented IT professionals in creating PHP websites to the very highest standards. Parth has a high awareness of industry issues and trends, particularly in regard to accessibility, usability, emerging technologies, and open source CMS..</p>
                            <p>He is an ambitious type who wants to get noticed, and has the drive and massive energy needed to really make a difference to a project. Right now He is looking for an intermediate level position with an exciting company that wants to attract talented people.</p>
               ...
               <section class="latest section">
                 ...
                 <section class="projects section">
                    <div class="section-inner">
                        <h2 class="heading">
                        	<img src="assets/images/wordpress.png" height="35px" widget="50px">
                        	  Wordpress Theme
                       	</h2>
                        <div class="content"> 
                        <table>
                        	<tr><td>                        	
	                        	<div class="item">
	                        		<img src="assets/images/screenshot.jpg" height="30%" width="55%">
	                        	</td><td>
	                        		<a class="btn btn-cta-secondary" href="https://github.com/devang137/rtCamp">Download This Theme <i class="fas fa-chevron-right"></i></a>
	                        	</div>
                        	</td></tr>
                        	<hr><br>
                        	<tr><td>                        	
	                        	<div class="item">
	                        		<img src="assets/images/screenshot2.png" height="30%" width="55%">
	                        	</td><td>
	                        		 <a class="btn btn-cta-secondary" href="https://github.com/devang137/Wordpress_Theme">Download This Theme <i class="fas fa-chevron-right"></i></a>
	                        	</div>
	                        </td></tr>
                        </table>                       
                            <!-- <div class="item">
                           ...
                           <!--  <div class="item">
                            ...
                            <!-- <a class="btn btn-cta-secondary" href="#">Download This Theme <i class="fas fa-chevron-right"></i></a> -->
                ...
                <section class="about section">
                    <div class="section-inner">
                        <h2 class="heading">Web developer skills acquired whilst studying</h2>
                        <div class="content">
                            <p>❖ Establishing the purpose of the website based upon its target audience.<br>
                                ❖ Open Source CMS theme integration and customization <br>
                                ❖ Open Source CMS extension integration and customization <br>
                                ❖ Comprehensive knowledge of Core PHP, Codeigniter, Zend HTML, XHTML, CSS, JavaScript, HTML5 and CSS3.<br>
                                ❖ Creating websites that are user-friendly, effective and appealing.<br>
                                ❖ Producing, modifying and maintaining websites and web
                                applications.<br>
                                ❖ Creating quality web pages.<br>
                                ❖ Explaining the costs and benefits of a proposed website to
                                customers and end users.<br>
                                ❖ Successful Search Engine Optimisation.<br>
                                ❖ Testing a website & identifying bugs & technical problems.<br>
                                ❖ Developing cross-browser and cross-platform compatible
                                solutions.<br>
                                ❖ Ability to read and understand framework like CI, Zend, cake
                                php.<br>
                                ❖ Designing, implementing and supporting database
                                development on an MySQL server.<br>
                                ❖ Github Working Experience </p>
                        </div>
                    </div>
                </section>
            ...
            <div class="secondary col-lg-4 col-12">
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                <li><i class="fas fa-map-marker-alt"></i><span class="sr-only">Location:</span>Ahmedabad</li>
                                <li><i class="fas fa-envelope"></i><span class="sr-only">Email:</span><a href="#">Devangvachheta123@gmail.com</a></li>
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            ...
                            <div class="skillset">
                                ...
                                <div class="item">
                                    <h3 class="level-title">Java &amp; jQuery<span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="You can use the tooltip to explain more about your skill level..."><i class="fas fa-info-circle"></i>Expert</span></h3>
                                    <div class="level-bar">
                                        <div class="level-bar-inner" data-level="96%">
                                        </div>                                      
                                    </div><!--//level-bar-->                                 
                                ...
                                <div class="item">
                                    <h3 class="level-title">HTML5, CSS3, JavaScript<span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="You can use the tooltip to explain more about your skill level..."><i class="fas fa-info-circle"></i>Expert</span></h3>
                                    <div class="level-bar">
                                        <div class="level-bar-inner" data-level="96%">
                                        </div>                                      
                                    </div><!--//level-bar-->                                 
                                ...
                                <div class="item">
                                    <h3 class="level-title">Ruby on Wordpress<span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="You can use the tooltip to explain more about your skill level..."><i class="fas fa-info-circle"></i>Pro</span></h3>
                                    <div class="level-bar">
                        ...
                        <div class="content">
                            <div class="item">
                                <blockquote class="quote">                                  
                                    <p><i class="fas fa-quote-left"></i>Devang is an excellent software engineer and he is passionate about what he does. You can totally count on him to deliver your projects!</p>
                                </blockquote>                
                ...
                <aside class="education aside section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <div class="item">                      
                                <h3 class="title"><i class="fas fa-graduation-cap"></i> 10<sup>th</sup>  SSC </h3>
                                <h4 class="university">Gujarat Board <span class="year">(2011-2012)</span></h4>
                            </div><!--//item-->
                            <div class="item">
                                <h3 class="title"><i class="fas fa-graduation-cap"></i> 12 <sup>th</sup> HSC</h3>
                                <h4 class="university">Gujarat Board <span class="year">(2013-2014)</span></h4>
                            </div><!--//item-->
                            <div class="item">
                                <h3 class="title"><i class="fas fa-graduation-cap"></i> Bachelors in computer application (BCA)</h3>
                                <h4 class="university">Gujarat university <span class="year">(2014–2017)</span></h4>
                            </div><!--//item-->
                            <div class="item">
                                <h3 class="title"><i class="fas fa-graduation-cap"></i> Master of Computer Applications (MCA)</h3>
                                <h4 class="university">Gujarat technological university <span class="year">(2017-2019)</span></h4>
                            </div><!--//item-->
                        </div><!--//content-->
                    </div><!--//section-inner-->
                </aside><!--//section-->
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                ...
                                <li class="item">
                                    ...
                                    <span class="level"> Native Speaker<br class="visible-sm visible-xs"/><i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star-half"></i></span>
                                </li><!--//item-->
                            </ul>
                        </div><!--//content-->
                    </div><!--//section-inner-->
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <ul class="list-unstyled pb-2">
                                ...
                                <li>Profile image: <a href="https://www.google.com/imgres?imgurl=https%3A%2F%2Fscontent-yyz1-1.cdninstagram.com%2Fvp%2Fb4a012c1920ff19bdf29f6f406d1112c%2F5C3D8F36%2Ft51.2885-19%2Fs150x150%2F37685735_894660207389960_7276170290189565952_n.jpg&imgrefurl=https%3A%2F%2Fwww.pintaram.com%2Fu%2Flalyo_41%2F1715736734208440899_2259786915&docid=j3jc0YOO77c-kM&tbnid=ElhEM5YzHLHd6M%3A&vet=10ahUKEwje1dyD_ozeAhXbSH0KHRQKC-8QMwhrKCswKw..i&w=150&h=150&bih=657&biw=1366&q=devang%20vachheta&ved=0ahUKEwje1dyD_ozeAhXbSH0KHRQKC-8QMwhrKCswKw&iact=mrc&uact=8" target="_blank">Devang Vachheta</a></li>
                            </ul>
                            
                            <hr/>
                            <p>Follow <a href="https://twitter.com/3rdwave_themes" target="_blank">Devang</a> on twitter so you don't miss any future freebies!</p> 
                            
                            <a class="btn btn-cta-secondary btn-follow" href="https://twitter.com/Devangvachheta2" target="_blank"><i class="fab fa-twitter"></i> Follow on twitter</a>
    ...
    <footer class="footer">
        <div class="container text-center">
                <small class="copyright">Designed with <i class="fas fa-heart"></i> by <a href="https://themes.3rdwavemedia.com" target="_blank">Devang B Vachheta</a> for developers</small>
        </div><!--//container-->
    </footer><!--//footer-->
