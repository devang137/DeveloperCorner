            ...
            <div class="primary col-lg-8 col-12">
                ...
                <section class="projects section">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-2"></div>
                        <div class="col-md-4">
                           <img height="100%" width="100%" src="assets/images/screenshot.jpg">
                        </div>   
                        <div class="col-md-2"></div>
                        <div class="col-md-2"></div> 
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-2"></div>
                        <div class="col-md-4">
                           <img height="100%" width="100%" src="assets/images/screenshot2.png">
                        </div>   
                        <div class="col-md-2"></div>
                        <div class="col-md-2"></div> 
                    </div>
        ...
        <aside class="skills aside section">
            <div class="section-inner">
                ...
                <div class="content">
                    ...
                    <div class="skillset">
                        <div class="item">
                            <h3 class="level-title">JavaScript &amp; jQuery &amp; Ajax<span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="You can use the tooltip to explain more about your skill level..."><i class="fas fa-info-circle"></i>Expert</span></h3>
                            <div class="level-bar">
                        ...
                        <div class="item">
                            <h3 class="level-title">Wordpress<span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="You can use the tooltip to explain more about your skill level..."><i class="fas fa-info-circle"></i>Pro</span></h3>
                            <div class="level-bar">
            ...
            <div class="section-inner">
                ...
                <div class="content">
                    <ul class="list-unstyled pb-2">
                        <li><a href="https://getbootstrap.com/" target="_blank"><i class="fas fa-external-link-alt"></i>Bootstrap 4</a></li>
                        ...
                        <li><a href="https://sweetalert2.github.io/" target="_blank"><i class="fas fa-external-link-alt"></i>Sweet Alert 2</a></li>
                        ...
                        <li><a href="https://daneden.github.io/animate.css/" target="_blank"><i class="fas fa-external-link-alt"></i>Animate.css</a></li>
