...
<head>
    ...
    <!-- Heder menu -->
    <link id="theme-style" rel="stylesheet" href="assets/css/sidemenu.css">
...
<body>
    ...
    <header class="header">
        ...
        <div class="zoomin frame">                    
            <img class="profile-image img-fluid float-left" src="assets/images/fb.png" alt="James Lee" />
             <div id="mySidenav" class="sidenav">
                  <a href="#" id="about">About</a>
                  <a href="#" id="blog">Blog</a>
                  <a href="#" id="projects">Projects</a>
                  <a href="#" id="contact23">Contact</a>
            </div>
        </div>
            ...
            <div class="profile-content float-left">
            	...
            	<a class="btn btn-cta-primary float-right" href="login.php" target="_blank"><i class="fas fa-paper-plane"></i>Connect with me</a>              
